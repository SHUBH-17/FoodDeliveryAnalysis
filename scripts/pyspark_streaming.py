...
kinesisStreamName = "incoming-food-order-data-sm"
kinesisRegion = "ap-south-1"
checkpointLocation = "s3://stream-checkpointing-sm/KinesisToRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-1.c9tf64gawcrj.ap-south-1.redshift.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://redshift-temp-data-sm/temp-data/streaming_temp/"
