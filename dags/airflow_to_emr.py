...
jdbc_jar_s3_path = "s3://food-delivery-data-analysis-sm/redshift-connector-jar/redshift-jdbc42-2.1.0.12.jar"
...
step_adder = EmrAddStepsOperator(
    task_id='add_step',
    job_flow_id='j-1RJX4YS8S2PQ3', #EMR Cluster ID
    ...
    steps=[{
        ...
        'HadoopJarStep': {
            ...
            'Args': [
                ...
                's3://food-delivery-data-analysis-sm/pyspark_script/pyspark_streaming.py',
